...
pub(crate) use gescom_noyau::argent::prochain_numero;
pub(crate) use gescom_noyau::argent::lire_lignes_raw;
...
/// `noyau::argent`.
pub(crate) use gescom_noyau::argent::valider_facture_sur;
