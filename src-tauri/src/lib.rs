...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commandes::logo::importer_image,
            commandes::logo::lister_images,
            commandes::logo::lire_images_base64,
            commandes::logo::supprimer_image,
            commandes::logo::sauvegarder_entete,
            commandes::logo::lire_entete_base64,
            commandes::logo::supprimer_entete,
            commandes::logo::sauvegarder_pied,
            commandes::logo::lire_pied_base64,
            commandes::logo::supprimer_pied,
            // ---- Impression ----
