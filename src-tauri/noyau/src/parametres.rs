...
pub fn lire_categories(conn: &rusqlite::Connection) -> Result<Vec<serde_json::Value>, String> {
...
pub fn creer_categorie(conn: &rusqlite::Connection, nom: String) -> Result<String, String> {
...
pub fn lire_articles_complets(conn: &rusqlite::Connection) -> Result<Vec<serde_json::Value>, String> {
    let mut stmt = conn.prepare(
...
pub fn lire_config_suivi_livraison(conn: &rusqlite::Connection) -> Result<bool, String> {
    let v: String = conn.query_row(
...
pub fn lire_stocks(conn: &rusqlite::Connection) -> Result<Vec<serde_json::Value>, String> {
    let mut stmt = conn.prepare(
